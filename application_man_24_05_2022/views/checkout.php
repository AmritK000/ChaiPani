    ...
    <div>
      ...
      <div class="card">
        ...
        <select name="address" id="address" style="width: 100%;">
          <?php foreach ($dilivertAddress as $key=> $da) { ?>
            <option value="<?=$da['village']?> <?=$da['street']?> <?=$da['area']?> <?=$da['city']?> <?=$da['country']?>"> <?=$da['village']?> <?=$da['street']?> <?=$da['area']?> <?=$da['city']?> <?=$da['country']?><!-- <address>
          Adam Johnson<br />
    ...
    <fieldset>
      ...
      <div class="form__radios">
        <div class="form__radio">
          ...
          <input checked id="razorpay" value="razorpay" name="payment-method" type="radio" />
        </div>

        <div class="form__radio">
          <label for="paypal"><svg class="icon">
            <img src="<?=base_url('assets/fav-icon.png')?>" style="width: 4%;margin-left: -13%;" >
              <!-- <use xlink:href="#icon-paypal" /> -->
            </svg>Arabian Points (<?php echo $ToatlPoints;?>)</label>
          <input id="arabianpoint" value="arabianpoint" name="payment-method" type="radio" <?php if($post_sufficient_point_error) { ?>checked<?php } ?>  />
        </div>
        <div class="form__radio" id="arab" style="<?php if($post_sufficient_point_error) { ?>display:block;<?php }else{ ?>display:none;<?php } ?>">
            <?php if ($post_sufficient_point_error) { ?>
            <label class="alert alert-danger" style="width:100%;color:red;"><?=$post_sufficient_point_error?></label>
           <?php } if ($sufficient_point_error && !$post_sufficient_point_error) { ?>
            <label class="alert alert-danger" style="width:100%;color:red;"><?=$sufficient_point_error?></label>
            <?php } ?> 
        </div>
    ...
    <div>
      ...
      <table>
        <tbody>
          <tr>
            <td>Shipping fee</td>
            <td align="right">AED <?php echo $shipping;?></td>
          </tr>
          <tr>
            <td>Price Total</td>
            <td align="right">AED <?php echo $finalprice;?></td>
          </tr>
        </tbody>
        <tfoot>
          <tr>
            <td>Total</td>
            <td align="right">AED <?php echo $finaltotal;?></td>
          </tr>
        </tfoot>
      </table>
    </div>
