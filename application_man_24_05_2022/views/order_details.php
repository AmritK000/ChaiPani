		...
		<?php include ('common/profile/menu.php') ?>
			<div class="col-md-9">
				...
				<div class="users_form">
					<div class="profiles">
						<h4 class="information" >Order History</h4>
					</div>
				<table>
				   <tr>
				     
				     
				      <th style="text-align:center;" col-span="2">Order Details</th>
				    ...
				    <tr>
				      ...
				      <td width="50%">Order ID:#66<P>Data Added : 15/5/2022</P></td>
				      <td width="50%">Payment Method <p>Shipping Method :Free Shipping </p></td>
				  ...
				  <table>
				   <tr>
				    ...
				    <tr>
				      ...
				      <td width="15%">Brand new T-Shirt</td>
