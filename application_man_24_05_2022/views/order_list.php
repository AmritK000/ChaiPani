									...
									<table class="table">
										<tbody>
											<tr>
												<td width="20%">
													<div class="cart-product">
														<img src="https://apkconnectlab.com/dealzarabia/assets/img/cart-img.png" class="img-fluid" alt="">
													</div>
												</td>
												<td width="100%">
													<div class="table-hd">
													...
													<ul class="ordered_list">
														<li>
															<a href="#"><i class="fa fa-map-marker" aria-hidden="true"></i><span>#23,sector:20,Chandigarh</span></a>
														</li>
														<li>
															<a href="#">Order Number:
														...
														<li>
															<a href="#">Date of Order :
															<p><span>5 April,2022</span></p>
															</a>
														</li>
														<li>
															<a href="#">Date of Delivery :
															<p><span>25 May,2022</span></p></a>
														</li>
													</ul>
												</td>
