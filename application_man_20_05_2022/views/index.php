		...
		<div class="row">
			<div class="col-lg-12 col-12">
				<div class="ad-img">
					...
					<img src="https://apkconnectlab.com/dealzarabia/./assets/img/middle-banner1.png">
				</div>
			</div>
		</div>
	</div>
						...
						<div class="item">
							<div class="sold-out-box">
								<div class="draw-header">
									<p>Draw Date: <?=date('d M, Y', strtotime($oos['draw_date']))?></p>
								</div>
								<div class="slide-product-box">
									<div class="product-img">
									...
									<div class="product-des">
										...
										<?php }else{
											/*$check = $this->geneal_model->checkWinner($oos['products_id']);
											echo $check; */
										?>

										<a href="#" class="soldout-btn">You are not a participant</a>
										<?php } ?>
										<!-- <a href="#" class="soldout-btn">You are not a participant</a> -->
									</div>
								</div>
