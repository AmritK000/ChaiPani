							...
							<div class="collapse navbar-collapse" id="collapsibleNavbar">
								...
								<ul class="navbar-nav ml-auto">
									...
									<li class="nav-item">
										...
										$rows = $this->geneal_model->getData2('count','da_cartItems',$wcon); ?>
											<a class="nav-link" id="cartA" href="<?=base_url('user-cart')?>"><b><i class="fal fa-shopping-cart" class="big_cart"></i>(<?=@$rows?>)</b></a>
										<?php }else{ ?>
											<a class="nav-link" id="cartA" href="<?=base_url('shopping-cart')?>"><b><i class="fal fa-shopping-cart" class="big_cart"></i>(<?=@count($this->cart->contents())?>)</b></a>
										<?php } ?>
