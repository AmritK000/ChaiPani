      ...
      <div class="form__radios">
        ...
        <div class="form__radio">
          <label for="paypal"><svg class="icon">
            ...
            </svg>Arabian Points</label>
          <input id="arabianpoint" value="arabianpoint" name="payment-method" type="radio" />
        </div>
        <div class="form__radio" id="arab" style="display:none;">
            <label id="arab_point"><?php echo $ToatlPoints;?> Arabian points left</label>
        <!--<input name="arab_point" id="arab_point" value="500" readonly>-->
        </div>
