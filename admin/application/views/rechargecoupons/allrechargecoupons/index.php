                          ...
                          <div class="row" style="margin:0px;">
                            <div class="col-sm-12 col-md-6">
                              <select name="searchField" id="searchField" class="custom-select custom-select-sm form-control form-control-sm">
                                ...
                                <option value="title" <?php if($searchField == 'aed')echo 'selected="selected"'; ?>>ADE Amount</option>
                              </select>
                            </div>
                            <div class="col-sm-12 col-md-6">
										  ...
										  <td>
											<div class="btn-group">
											  ...
											  <ul class="dropdown-menu" role="menu">
												<!-- <li><a href="<?php echo getCurrentControllerPath('addeditdata/'.$ALLDATAINFO['rc_id'])?>"><i class="fas fa-edit"></i> Edit Details</a></li> -->
