  ...
  <div class="navbar-wrapper  ">
    <div class="navbar-content scroll-div " >
      <div class="">
        ...
        <div class="main-menu-header" >
          <img src="<?=base_url('assets/admin/image/logo.png')?>" style="width: 75%;">
          <!-- <canvas id="clockCanvas" width="100" height="100"style="background-color:#fff"></canvas> -->
          <!-- <div id="clockText" style="color:#000;"></div> -->
        </div>
        ...
        ?>
            <li class="nav-item pcoded-hasmenu <?php if(strtolower($activeMenu) == $menuDInfo['module_name']):?> active pcoded-trigger<?php endif; ?>">
                ...
                <ul class="pcoded-submenu">
                    ...
                    <li <?php if(strtolower($activeSubMenu) == $menuChildDInfo->module_name):?>class="active"<?php endif; ?>><a href="{FULL_SITE_URL}<?php echo stripslashes($menuDInfo['module_name']); ?>/<?php echo stripslashes($menuChildDInfo->module_name); ?>/index"><?php echo stripslashes($menuChildDInfo->module_display_name); ?></a></li>
                    <?php endforeach; ?>
                </ul>
            </li>
        <?php else: ?> 
...
<script type="text/javascript">
  function startTime() {
    var d = new Date();
    var utc = d.getTime() + (d.getTimezoneOffset() * 60000);
    var today = new Date(utc + (3600000*4));
