                                  ...
                                  <td>
                                    <div class="btn-group">
                                      ...
                                      <ul class="dropdown-menu" role="menu">
                                        <li><a href="<?php echo getCurrentControllerPath('addeditdata/'.$ALLDATAINFO['privacy_policy_id'])?>"><i class="fas fa-edit"></i> Edit Details</a></li>
                                       </ul>
                                    </div>
                                  </td>
                                </tr>
