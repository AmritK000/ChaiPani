                            ...
                            <tbody style="text-align: center;">
                              ...
                              ?>
                                <tr role="row" class="<?php echo $rowClass; ?>">
                                  <td><?=$i++?></td>
                                  <td><?=stripslashes($ALLDATAINFO['question'])?></td>
                                  <td><textarea class="scrollabletextbox"><?=stripslashes(strip_tags($ALLDATAINFO['answer']))?></textarea></td>
                                  <td>
                                    <div class="btn-group">
                                      <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action</button>
                                      <ul class="dropdown-menu" role="menu">
                                        <li><a href="<?php echo getCurrentControllerPath('addeditdata/'.$ALLDATAINFO['help_id'])?>"><i class="fas fa-edit"></i> Edit Details</a></li>
                                       </ul>
                                    </div>
                                  </td>
                                </tr>
