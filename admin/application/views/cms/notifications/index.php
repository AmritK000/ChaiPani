          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                ...
                <a href="<?php echo getCurrentControllerPath('addeditdata'); ?>" class="btn btn-sm btn-primary pull-right">Add Notification</a>
              </div>
              <div class="card-body">
                            ...
                            <tbody style="text-align: center">
                              ...
                              ?>
                                <tr role="row" class="<?php echo $rowClass; ?>">
                                  ...
                                  <td><textarea class="scrollabletextbox"><?=stripslashes(strip_tags($ALLDATAINFO['description_en']))?></textarea></td>
