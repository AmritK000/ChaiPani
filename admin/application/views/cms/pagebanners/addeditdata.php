                  ...
                  <form id="currentPageForm" name="currentPageForm" class="form-auth-small" method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="form-group-inner col-lg-6 col-md-6 col-sm-6 col-xs-12 <?php if(form_error('slider_image')): ?>error<?php endif; ?>">
                        ...
                        <input type="file" name="slider_image" id="slider_image" value="<?php if(set_value('slider_image')): echo set_value('slider_image'); endif; ?>" accept="image/png, image/jpeg">
                         <p style="font-family:italic; color:red;">[Image Size : 1600 x 795 px in jpg/jpeg/png]</p>
