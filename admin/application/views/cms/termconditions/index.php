            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Terms & conditions</a></li>
                    </ul>
                </div>
            </div>
        </div>
                                  ...
                                  <td>
                                    <div class="btn-group">
                                      ...
                                      <ul class="dropdown-menu" role="menu">
                                        <li><a href="<?php echo getCurrentControllerPath('addeditdata/'.$ALLDATAINFO['terms_condition_id'])?>"><i class="fas fa-edit"></i> Edit Details</a></li>
                                       </ul>
                                    </div>
                                  </td>
                                </tr>
