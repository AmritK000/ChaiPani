          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                ...
                <a href="<?php echo getCurrentControllerPath('addeditdata'); ?>" class="btn btn-sm btn-primary pull-right">Add Sub-category</a>
              </div>
              <div class="card-body">
									...
									<tbody style="text-align: center;">
									  ...
									  ?>
										<tr role="row" class="<?php echo $rowClass; ?>">
										  ...
										  <td><?=stripslashes($ALLDATAINFO['sub_category'])?></td>
										  <td>
											<?php if($ALLDATAINFO['sub_cat_image']): ?>
											  <img src="<?=fileBaseUrl.stripslashes(($ALLDATAINFO['sub_cat_image']))?>" width="100" alt="<?=stripslashes($ALLDATAINFO['sub_cat_image_alt'])?>">
											<?php endif; ?>
										  </td>
