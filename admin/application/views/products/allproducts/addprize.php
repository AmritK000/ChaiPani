                ...
                <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group-inner col-lg-6 col-md-6 col-sm-6 col-xs-12 <?php if(form_error('prize_image')): ?>error<?php endif; ?>">
                        ...
                        <input type="file" name="prize_image" id="prize_image" class="" value="<?php if(set_value('prize_image')): echo set_value('prize_image'); endif; ?>" accept="image/png, image/jpeg" <?php if(empty($EDITDATA['prize_image'])){?>
                            required
                        <?php } ?> >
