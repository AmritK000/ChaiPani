                ...
                <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group-inner col-lg-6 col-md-6 col-sm-6 col-xs-12 <?php if(form_error('product_image')): ?>error<?php endif; ?>">
                        ...
                        <input type="file" name="product_image" id="product_image" class="" value="<?php if(set_value('product_image')): echo set_value('product_image'); endif; ?>" accept="image/png, image/jpeg" <?php if(empty($EDITDATA['product_image'])){ ?> required <?php } ?> >
                        ...
                        <?php endif; ?>
                                ...
                                <div class="row">
                                    <div class="form-group-inner col-lg-4 col-md-4 col-sm-4 col-xs-12 <?php if(form_error('stock')): ?>error<?php endif; ?>">
                                        ...
                                        <input type="number" min="0" name="stock" id="stock" class="form-control required" value="<?php if(set_value('stock')): echo set_value('stock'); else: echo stripslashes($EDITDATA['stock']);endif; ?>" placeholder="Quantity" <?php if(($EDITDATA['stock'])){ ?>
                                            readonly
                                        <?php } ?>>
                                    ...
                                    <div class="form-group-inner col-lg-4 col-md-4 col-sm-4 col-xs-12 <?php if(form_error('clossingSoon')): ?>error<?php endif; ?>">
                                        <label>Closing Soon Category <span class="required">*</span></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group-inner col-lg-4 col-md-4 col-sm-4 col-xs-12 <?php if(form_error('draw_date')): ?>error<?php endif; ?>">
                                    ...
                                    <div class="form-group-inner col-lg-4 col-md-4 col-sm-4 col-xs-12 <?php if(form_error('validuptodate')): ?>error<?php endif; ?>">
                                    ...
                                    <div class="form-group-inner col-lg-4 col-md-4 col-sm-4 col-xs-12 <?php if(form_error('validuptotime')): ?>error<?php endif; ?>">
