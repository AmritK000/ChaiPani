          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                ...
                <a href="<?php echo base_url('products/allproducts/addprize'); ?>" class="btn btn-sm btn-primary pull-right">Add prize</a>
              </div>
              <div class="card-body">
                  ...
                  <tbody style="text-align: center;">
                    ...
                    <tr role="row" class="<?php echo $rowClass; ?>">
                      ...
                      <div class="btn-group">
                        ...
                        <li><a href="<?php echo base_url('products/allproducts/addprize/'.$ALLDATAINFO['prize_id'])?>"><i class="fas fa-edit"></i> Edit Details</a></li>
