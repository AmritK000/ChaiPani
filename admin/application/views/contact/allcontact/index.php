                ...
                <form id="Data_Form" name="Data_Form" method="get" action="<?php echo $forAction; ?>">
                  <div class="dt-responsive table-responsive">
                          ...
                          <div class="row" style="margin:0px;">
                            <div class="col-sm-12 col-md-6">
                              <select name="searchField" id="searchField" class="custom-select custom-select-sm form-control form-control-sm">
                                ...
                                <option value="Email" <?php if($searchField == 'email')echo 'selected="selected"'; ?>>Email</option>
                    ...
                    <th width="10%">Action</th>
                      ...
                      <td><?=stripslashes($ALLDATAINFO['subject'])?></td>
                      ...
                      <td>
											...
											<!-- <li><a href="<?php echo getCurrentControllerPath('addeditdata/'.$ALLDATAINFO['id'])?>"><i class="fas fa-edit"></i> Edit Details</a></li>
												<?php if($ALLDATAINFO['status'] == 'A'): ?>
												  <li><a href="<?php echo getCurrentControllerPath('changestatus/'.$ALLDATAINFO['id'].'/I')?>"><i class="fas fa-thumbs-down"></i> Inactive</a></li>
												<?php elseif($ALLDATAINFO['status'] == 'I'): ?>
												  <li><a href="<?php echo getCurrentControllerPath('changestatus/'.$ALLDATAINFO['id'].'/A')?>"><i class="fas fa-thumbs-up"></i> Active</a></li>
												<?php endif; ?> -->
