...
class Cancellationpolicy extends CI_Controller {
	...
	public function index()
	{
		...
		$data['error'] 						= 	'';
		$data['activeMenu'] 				= 	'cms';
		$data['activeSubMenu'] 				= 	'Cancellation Policy';
       ...
       if ($this->uri->segment(getUrlSegment())):
		...
		$this->layouts->set_title('Cancellation policy | CMS | Dealz Arabia');


		$this->layouts->admin_view('cms/cancellationpolicy/index',array(),$data);
	}	// END OF FUNCTION
	...
	{		
		...
		if($editId):
			...
			$data['EDITDATA']		=	$this->common_model->getDataByParticularField('da_cms','cancellation_policy_id',(int)$editId);
		else:
		...
		if($this->input->post('SaveChanges')): 
			...
			if($this->form_validation->run() && $error == 'NO'):  
				...
				if($this->input->post('CurrentDataID') ==''):
					...
					$this->common_model->editData('da_cms',$param,'cancellation_policy_id',(int)$NotificationTempId);
		...
		$this->layouts->set_title('Add/Edit Cancellation Policy | CMS | Dealz Arabia');
		$this->layouts->admin_view('cms/cancellationpolicy/addeditdata',array(),$data);
	...
	{  
		...
		$this->common_model->editData('da_cms',$param,'cancellation_policy_id',(int)$changeStatusId);
	...
	{  
		...
		$this->common_model->deleteData('da_cms','cancellation_policy_id',(int)$deleteId);
