...
class Faqs extends CI_Controller {
	...
	{	
       ...
       if($this->uri->segment(getUrlSegment())):
		...
		$this->layouts->set_title('Faqs | CMS | Dealz Arabia');
		$this->layouts->admin_view('cms/faqs/index',array(),$data);
	}	// END OF FUNCTION
	/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	 +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	{		
		...
		if($editId):
			...
			$data['EDITDATA']				=	$this->common_model->getDataByParticularField('da_cms','faqs_id',(int)$editId);
		else:
		...
		if($this->input->post('SaveChanges')):
			...
			if($this->form_validation->run() && $error == 'NO'): 
				...
				if($this->input->post('CurrentDataID') ==''):
					$param['faqs_id']			=	(int)$this->common_model->getNextSequence('da_cms');
					...
					$this->common_model->editData('da_cms',$param,'faqs_id',(int)$aboutId);
		...
		$this->layouts->set_title('Add/Edit Faqs | CMS | Dealz Arabia');
