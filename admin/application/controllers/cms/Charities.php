...
class Charities extends CI_Controller {
	...
	{		
		...
		if($editId):
			...
			$data['EDITDATA']				=	$this->common_model->getDataByParticularField('da_cms','charities_id',(int)$editId);
		else:
		...
		if($this->input->post('SaveChanges')):
			...
			if($this->form_validation->run() && $error == 'NO'): 
				...
				if($this->input->post('CurrentDataID') ==''):
					$param['charities_id']			=	(int)$this->common_model->getNextSequence('da_cms');
					...
					$this->common_model->editData('da_cms',$param,'charities_id',(int)$aboutId);
