...
class Department extends CI_Controller {
	...
	{		
		...
		if($editId):
			...
			$data['EDITDATA']		=	$this->common_model->getDataByParticularField('hcap_admin_department','department_id',(int)$editId);
		else:
		...
		if($this->input->post('SaveChanges')):
			$error					=	'NO';
			$this->form_validation->set_rules('department_name', 'Department Name', 'trim|required|is_unique[hcap_admin_department.department_name.string]');
			...
			if($this->form_validation->run() && $error == 'NO'):   
				...
				if($this->input->post('CurrentDataID') ==''):
					$param['department_id']		=	(int)$this->common_model->getNextSequence('hcap_admin_department');
					$param['department_used']	=	'N';
					$param['creation_ip']		=	currentIp();
					$param['creation_date']		=	(int)$this->timezone->utc_time();//currentDateTime();
					$param['created_by']		=	(int)$this->session->userdata('HCAP_ADMIN_ID');
					$param['status']			=	'A';
					$alastInsertId				=	$this->common_model->addData('hcap_admin_department',$param);
					...
					$this->common_model->editData('hcap_admin_department',$param,'department_id',(int)$departId);
	...
	************************************************************************/
	...
	{  
		...
		$this->common_model->editData('hcap_admin_department',$param,'department_id',(int)$changeStatusId);
	...
	************************************************************************/
	...
	{  
		...
		$this->common_model->deleteData('hcap_admin_department','department_id',(int)$deleteId);
