...
class Designation extends CI_Controller {
	...
	{	
		...
		$tblName 							= 	'hcap_admin_designation';
		$con 								= 	'';
	...
	{		
		...
		if($editId):
			...
			$data['EDITDATA']		=	$this->common_model->getDataByParticularField('hcap_admin_designation','designation_id',(int)$editId);
		else:
		...
		if($this->input->post('SaveChanges')):
			$error					=	'NO';
			$this->form_validation->set_rules('designation_name', 'Name', 'trim|required|is_unique[hcap_admin_designation.designation_name.string]');
			...
			if($this->form_validation->run() && $error == 'NO'):   
				...
				if($this->input->post('CurrentDataID') ==''):
					$param['designation_id']	=	(int)$this->common_model->getNextSequence('hcap_admin_designation');
					$param['designation_used']	=	'N';
					$param['creation_ip']		=	currentIp();
					$param['creation_date']		=	(int)$this->timezone->utc_time();//currentDateTime();
					$param['created_by']		=	(int)$this->session->userdata('HCAP_ADMIN_ID');
					$param['status']			=	'A';
					$alastInsertId				=	$this->common_model->addData('hcap_admin_designation',$param);
					...
					$this->common_model->editData('hcap_admin_designation',$param,'designation_id',(int)$departmentId);
	...
	************************************************************************/
	...
	{  
		...
		$this->common_model->editData('hcap_admin_designation',$param,'designation_id',(int)$changeStatusId);
	...
	************************************************************************/
	...
	{  
		...
		$this->common_model->deleteData('hcap_admin_designation','designation_id',(int)$deleteId);
