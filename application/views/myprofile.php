			...
			<div class="col-md-9">
				...
				<div class="users_form">
					...
					<div class="change_password">
						 <a href="javascript:void(0);" class="user_password" onclick="ConfirmForm();">Change your password</a>
						...
						<div class="users_form">
							...
							<form class="form-inline" id="form" action="" method="post">
								...
								<label class="password">Old Password</label>
									  <input type="password" name="old_password" id="old_password" value="<?php if(set_value('old_password')): echo set_value('old_password'); endif; ?>" placeholder="Old Password" class=" <?php if(form_error('old_password')): ?>error<?php endif; ?>">
								...
								<label class="password">New Password</label>
									  <input type="password" name="new_password" id="new_password" value="<?php if(set_value('new_password')): echo set_value('new_password'); endif; ?>" placeholder="New Password" class=" <?php if(form_error('new_password')): ?>error<?php endif; ?>">
								...
								<div class="inputWithIcon" style="margin-right:0px;">
									...
									<input type="password" name="conf_password" id="conf_password" value="<?php if(set_value('conf_password')): echo set_value('conf_password'); endif; ?>" placeholder="Confirm Password" class=" <?php if(form_error('conf_password')): ?>error<?php endif; ?>">
