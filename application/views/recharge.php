				...
				<div class="users_form">
					...
					<div class="col-md-6 px-0">
						<div class="inputWithIcon">
						  <input type="text" autocomplete="off" name="email" id="email" value="<?php if(set_value('email')): echo set_value('email'); endif; ?>" placeholder="Email / Mobile">
					...
					<div class="inputWithIcon" style="margin-right:0px;">
						  <input type="number" min="1" autocomplete="off" name="recharge_amt" id="recharge_amt" value="<?php if(set_value('recharge_amt')): echo set_value('recharge_amt'); endif; ?>" placeholder="Recharge amount">
						  <i class="fa fa-address-card" aria-hidden="true"></i>
					...
					<div class="user_list" style="overflow-x: auto;">
					  <table>
					    ...
					    <?php $i=1; foreach ($users as $key => $items) { 
					    	$where 			= 	['users_id'=>(int)$items['user_id_cred'],'status'=>'A'];
					    ...
					    <tr>
					      ...
					      <td width="5%"><?=$items['arabian_points']?></td>
					    </tr>
					    <?php $i++; } ?>
					  </table>
