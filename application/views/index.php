	...
	<div class="full-container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-12 padding-zero">
				<div class="owl-slider sliderss">
					<div id="main-carousel" class="owl-carousel big_slider">
			...
			<div class="owl-slider my_slider1">
					<div id="main-carousel2" class="owl-carousel big_slider">
					<div class="item">
					<img src="assets/img/Banners.jpg" class="img-fluid" alt="">
					</div>
					<div class="item">
					<img src="assets/img/Banner8.jpg" class="img-fluid" alt="">
					</div>
					<div class="item">
					<img src="assets/img/Banner_9.jpg" class="img-fluid" alt="">
					</div>
