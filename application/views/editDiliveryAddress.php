		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="users_form">
					...
					<div class="col-md-6 px-0">
						<div class="inputWithIcon">
							  <input type="text" name="village" value="<?php if(set_value('village')): echo set_value('village'); else: echo stripslashes($address['village']); endif; ?>" placeholder="Village/Town Name" class=" <?php if(form_error('village')): ?>error<?php endif; ?>">
					...
					<div class="col-md-6 px-0">
						<div class="inputWithIcon" style="margin-right:0px;">
							  <input type="text" name="street" value="<?php if(set_value('street')): echo set_value('street'); else: echo stripslashes($address['street']); endif; ?>" placeholder="Street Name or No." class=" <?php if(form_error('street')): ?>error<?php endif; ?>">
						 	 <i class="fal fa-city"></i>
					...
					<div class="col-md-6 px-0">
						<div class="inputWithIcon">
						  <input type="text" name="area" value="<?php if(set_value('area')): echo set_value('area'); else: echo stripslashes($address['area']); endif; ?>" placeholder="Area" class=" <?php if(form_error('area')): ?>error<?php endif; ?>">
						  <i class="fal fa-city"></i>
					...
					<div class="col-md-6 px-0" >
						<div class="inputWithIcon" style="margin-right:0px;">
						  <input type="text" name="city" value="<?php if(set_value('city')): echo set_value('city'); else: echo stripslashes($address['city']); endif; ?>" placeholder="City" class=" <?php if(form_error('city')): ?>error<?php endif; ?>">
						 <i class="fal fa-city"></i>
					...
					<div class="col-md-6 px-0">
						<div class="inputWithIcon">
						  <input type="text" name="pincode" value="<?php if(set_value('pincode')): echo set_value('pincode'); else: echo stripslashes($address['pincode']); endif; ?>" placeholder="Pincode" class=" <?php if(form_error('pincode')): ?>error<?php endif; ?>">
					...
					<div class="col-md-6 px-0">
						<div class="inputWithIcon">
						  <input type="text" name="country" value="<?php if(set_value('country')): echo set_value('country'); else: echo stripslashes($address['country']); endif; ?>" placeholder="Country" class=" <?php if(form_error('country')): ?>error<?php endif; ?>">
					...
					<div class="col-md-6 px-0">
						<div class="inputWithIcon"  style="margin-right:0px;">
						  <input type="text" name="mobile" value="<?php if(set_value('mobile')): echo set_value('mobile'); else: echo stripslashes($address['mobile']); endif; ?>" placeholder="Mobile No." class=" <?php if(form_error('mobile')): ?>error<?php endif; ?>">
